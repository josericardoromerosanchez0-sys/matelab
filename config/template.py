...
THEME_VARIABLES = {
    ...
    "og_title": "Materio Bootstrap 5 HTML + Django Admin Template by ThemeSelection",
    "og_image": "https://ts-assets.b-cdn.net/ts-assets/materio/materio-bootstrap-django-admin-template/marketing/materio-bootstrap-django-admin-template-smm.png",
    "og_type": "product",
}
